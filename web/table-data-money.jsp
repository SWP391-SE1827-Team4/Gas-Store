<%-- 
    Document   : table-data-money
    Created on : May 12, 2024, 9:50:04 PM
    Author     : xuank
--%>
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <!--                <li><a class="app-menu__item active" href="table-data-money.jsp"><i class='app-menu__icon bx bx-dollar'></i><span
