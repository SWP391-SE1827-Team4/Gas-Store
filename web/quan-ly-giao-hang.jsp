...
<%@ page import="java.util.List, model.Shipping" %>
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item active haha" href="quan-ly-giao-hang.jsp"><i class='app-menu__icon bx bx-package' ></i>
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Danh sách Lịch Trình đơn hàng</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>ID Ship</th>
                                        <th>ID Staff Chịu Trách Nhiệm</th>
                                        <th>ID Order_Detail</th>
