<%-- 
    Document   : page-calendar
    Created on : May 12, 2024, 9:49:16 PM
    Author     : xuank
--%>
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item active" href="page-calendar.jsp"><i class='app-menu__icon bx bx-calendar-check'></i><span
