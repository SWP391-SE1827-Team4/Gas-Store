            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form class="row" action="updateP" method="post">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div id="myfileupload">
                                        <input type="text" id="imageUpload" name="ImageUpload" onchange="previewImage(this.value);" placeholder="Enter image URL" />
                                    </div>
                                    <div id="thumbbox">
                                        <img height="450" width="400" alt="Thumb image" id="thumbimage" style="display: none" />
                                        <a class="removeimg" href="javascript:"></a>
                                ...
                                <input type="hidden" name="service" value="insertProducts">
                            </form>
                        </div>
                    </div>
                </div>
